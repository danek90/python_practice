...
for page_number in dir_list:
    rootDir = "/Users/dkania/Documents/bloodDrive_20180827/images/name_stickers/{}".format(page_number)
    from PIL import Image, ImageFont, ImageDraw, ImageOps
    import os
    from os import listdir
    from os.path import isfile, join
    ...
    page.save("{}/{}_name_temp.png".format(rootDir, page_number))

    final = Image.open("{}/{}_name_temp.png".format(rootDir, page_number))
    ...
    outer_page.save("{}/{}_output_name.png".format(outputDir, page_number))
    os.remove("{}/{}_name_temp.png".format(rootDir, page_number))
